function makeStory() {
    ...
    var lastname1 = document.getElementById('last-name1').value;
    var lastname2 = document.getElementById('last-name2').value;
    var noun1 = document.getElementById('noun1').value;
    var noun2 = document.getElementById('noun2').value;
    var pluralanimal = document.getElementById('plural-animal').value;
    var pluralnoun1 = document.getElementById('plural-noun1').value;
    var pluralnoun2 = document.getElementById('plural-noun2').value;
    var pluralnoun3 = document.getElementById('plural-noun3').value;
    var pluralnoun4 = document.getElementById('plural-noun4').value;
    var pluralnoun5 = document.getElementById('plural-noun5').value;


    // Set title of story. Use at least one form value in the title. (2 points)
    var title = "Rock Music";
